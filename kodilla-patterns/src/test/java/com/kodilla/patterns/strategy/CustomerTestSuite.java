...
public class CustomerTestSuite {
    ...
    void testDefaultInvestingStrategies(){
        ...
        System.out.println("Kodilla should buy: " + kodilla.predict());
        //Then
        ...
        assertEquals("[Balanced predictor] Buy shared units of Fund XYZ", kodilla.predict());
    ...
    void testIndividualInvestingStrategy(){
        ...
        System.out.println("Steven no should: " + stevenShouldBuy);
        //Then
